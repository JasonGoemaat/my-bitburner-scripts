...
export function calculateAll(server, player, threads = 1, cores = 1) {
  return {
    hackingChance: calculateHackingChance(server, player),
    hackingExpGain: calculateHackingExpGain(server, player),
    percentMoneyHacked: calculatePercentMoneyHacked(server, player),
    hackingTime: calculateHackingTime(server, player),
    growTime: calculateGrowTime(server, player),
    weakenTime: calculateWeakenTime(server, player),
    intelligenceBonus: calculateIntelligenceBonus(player.intelligence),
    serverGrowth: calculateServerGrowth(server, threads, player, cores),
    security: {
...
export default {
  hackingChance: calculateHackingChance,
  hackingExpGain: calculateHackingExpGain,
  percentMoneyHacked: calculatePercentMoneyHacked,
  hackingTime: calculateHackingTime,
  growTime: calculateGrowTime,
  weakenTime: calculateWeakenTime,
  intelligenceBonus: calculateIntelligenceBonus,
  serverGrowth: calculateServerGrowth,
  all: calculateAll,
}
